...
export const mainServerHostname = production ? `studioquiz-git-${process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_REF || process.env.BRANCH_NAME}-jeans-projects-0b2ad0ac.vercel.app` : "localhost";
